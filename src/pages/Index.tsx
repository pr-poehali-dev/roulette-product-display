...
const prizes = [
  { id: 1, text: 'BYBIT', type: 'product', color: '#1a1f2e', image: 'https://cdn.poehali.dev/files/51e9f46f-7515-4069-9a4f-609e5c3d3f4b.png', description: 'Торговая платформа', discount: { type: 'percent', value: 20 } },
  { id: 2, text: 'Product 2', type: 'product', color: '#a3e635', image: 'https://cdn.poehali.dev/files/37b1984d-b698-4108-a1ba-628d101ae93e.png', description: 'Зелёный продукт', discount: { type: 'percent', value: 35 } },
  ...
  { id: 4, text: 'Product 4', type: 'product', color: '#a855f7', image: 'https://cdn.poehali.dev/files/6a9337b5-b7d7-4642-b210-55676cb99989.png', description: 'Фиолетовый продукт', discount: { type: 'ruble', value: 500 } },
